...
def get_label_from_filename(filepath):
    return os.path.basename(filepath).replace("-hbnum.xvg", "")

def plot_hbnum(input_files, output_file):
    ...
    ax_main.set_ylabel("Number of Hydrogen Bonds", fontsize=14)
    ax_main.set_xlim(0, max_time)
    ax_main.set_ylim(0, max_hb * 1.05)
    ...
    fig.suptitle("Hydrogen Bonds (hbnum)", fontsize=16, y=0.96)
